...
if(isset($idGroupSearch)){
	...
	$studentListTable .= '
		<div class="instructionsText">Lista de alumnos del grupo, para continuar elija un alumno para hacer el reporte:</div>
		<table class="table">
			<tr>
	                ...
	                while ($row = $result->fetch_array()) {
		                ...
		                $studentListTable .= '
		                    <tr>
		                        ...
		                        <td>'. $nameTxt .'</td>
		                        <td>
		                            <button type="button" class="btn btn-primary buttonTable2" onclick="loadReportForm( '. $idStudentTxt .')">Seleccionar</button>
		                        </td>
		                    </tr>
		                ';
	                	$i++;
